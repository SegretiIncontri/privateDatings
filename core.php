...
function SendEmail($to, $subject, $message, $db = false) {
    ...
    $html_body = '<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <title>
    </title>
...
<body>
<div>
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#30373b;background-color:#30373b;width:100%;max-width: 600px;">
        <tbody>
        <tr>
            <td>
                                        ...
                                        <tbody><tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:left;text-decoration:none;">
                                                    Have an affair, life is beautiful.
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody></table>
                                        ...
                                        <tbody><tr>
                                            <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:right;text-decoration:none;">
                                                    <a href="https://segreti-incontri.com" style="text-decoration:underline; color:#848789;" target="_blank">
                                                        LOGIN
                                                    </a>
                                                </div>
                                            </td>
    ...
    <![endif]-->
    <div style="margin:0px auto;max-width:600px;background: #30373b;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        ...
                                        <tr>
                                            <td style="width:230px;">
                                                <a href="https://segreti-incontri.com" target="_blank">
                                                    <img alt="https://segreti-incontri.com" height="80" src="https://segreti-incontri.com/themes/todate/assets/img/logo-light.png" style="border:0;display:block;font-size:13px;/* height:80px; */outline:none;text-decoration:none;width:100%;" width="230">
                                                </a>
                                            </td>
                                        </tr>
                                        </tbody>
                                            ...
                                            <td style="padding:10px;vertical-align:top;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:5px;word-break:break-word;">
                                                            <div style="color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;">
                                                                <a href="https://segreti-incontri.com/privacy" style="text-decoration:underline; color:#848789;" target="_blank">
                                                                    PRIVACY POLICY
                                                                </a>
                                                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                                                <a href="https://segreti-incontri.com/terms" style="text-decoration:underline; color:#848789;" target="_blank">
                                                                    TERMS OF SERVICE
                                                                </a>
                                                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                                                <a href="https://segreti-incontri.com/about" style="text-decoration:underline; color:#848789;" target="_blank">
                                                                    USER CONTRACT
                                                                </a>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:5px;word-break:break-word;">
                                                            <div style="color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;">
                                                                ©2&zwnj;019 segreti-incontri.com. All Rights Reserved.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
function GetSiteUsers(){
    ...
    $sql  = mysqli_query($conn, 'SELECT * FROM `users` WHERE `active` = "1" AND `gender` = "4526" ORDER BY `id` DESC LIMIT '.$showed_user.' ;');
    while ($fetched_data = mysqli_fetch_assoc($sql)) {
...
function GetNonProMaxUserChatsPerDay($userid){
    global $conn;
    $data      = array();
    $query_one = "SELECT COUNT(DISTINCT(messages.`to`)) as ChatCount FROM messages WHERE messages.`from` = ".$userid." ORDER BY messages.`to`";
    $sql       = mysqli_query($conn, $query_one);
    while ($fetched_data = mysqli_fetch_assoc($sql)) {
...
function GetNonProMaxUserMessagesimit($userid)
{
    global $conn;
    $data = array();
    $query_one = "SELECT COUNT(*) as ChatCount FROM messages WHERE messages.`from` = " . $userid . " ORDER BY messages.`to`";
    $sql = mysqli_query($conn, $query_one);
    while ($fetched_data = mysqli_fetch_assoc($sql)) {
        $data['ChatCount'] = $fetched_data['ChatCount'];
    }
...
function isNonProBuyChatCredits($userid,$chat_userid){
    ...
    $data      = array();
    $row_cnt = 0;
    $query_one = "SELECT id FROM user_chat_buy WHERE `user_id` = ".$userid." AND `chat_user_id` = ".$chat_userid." LIMIT 1";
...
function GetFindMatcheQuery($user_id, $limit, $offset, $country = false,$search = false){
    global $config,$db;
    $u = auth();
...
//    }
    ...
    if( isset($_POST['username']) && !empty($_POST['username']) ){
        $where_and2[] = '`username` like "%'. Secure($_POST['username']) .'%"';
    }
    ...
    if( isset($_POST['username']) && !empty($_POST['username']) ){
        $where_and2[] = '`username` = "'. Secure($_POST['username']) . '"';
    }
...
function Wo_GetReferrersList() {
    ...
    $data          = array();
    $query_one     = "SELECT * FROM `users` WHERE `permission` IS NOT NULL ORDER BY `id` DESC";
    $sql_query_one = mysqli_query($conn, $query_one);
    while ($fetched_data = mysqli_fetch_assoc($sql_query_one)) {
        $data[] = Wo_UserData($fetched_data['id']);
    }
