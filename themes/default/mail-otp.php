						...
						<form method="POST" action="/Useractions/mailotp" class="register">
							...
							<div class="enter_otp_email" style="display: block;margin: 0px;padding: 0px;border: 0px;">
								<div id="otp_outer" style="margin: 0px;">
									<div id="otp_inner">
										<input id="otp_check_email" name="email_code" type="text" maxlength="4" value="" pattern="\d*" title="Field must be a number." onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required  /><br><br>
