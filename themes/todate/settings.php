    ...
    <div class="col m12 l8">
        <form method="POST" action="/profile/save_general_setting" class="dt_settings">
            ...
            <div class="row mb-0">
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input readonly name="username" id="username" class="browser-default" type="text" placeholder="<?php echo __( 'Username' );?>" value="<?php echo $profile->username;?>">
						<label for="username"><?php echo __( 'Username' );?></label>
					</div>
                </div>
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input readonly name="email" id="email" class="browser-default" type="email" placeholder="<?php echo __( 'Email' );?>" value="<?php echo $profile->email;?>">
            ...
            <?php if( $admin_mode == true ){?>
                ...
                <div class="row mb-0">
                    ...
                    <div class="col m6 s12">
                        <div class="to_mat_input">
                            <select id="pro_type" name="pro_type" class="browser-default pp_select_has_label">
                                <?php echo DatasetGetSelect( $profile->pro_type, "pro_types", "Choose premium type" );?>
                            </select>
                            <label for="pro_type">Premium Type</label>
                        </div>
                    </div>
                </div>
