				...
				<div class="pay_using">
					...
					<div class="pay_u_btns">
						<?php if(!empty($config->paypal_id)){?>
							<button id="lock_pro_video_paypal" onclick="clickAndDisable(this);" class="btn valign-wrapper">
						...
						<?php if(!empty($config->stripe_secret)){?>
							<button id="lock_pro_video_stripe" class="btn valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm17 9H4v7h16v-7zm0-4V5H4v3h16z" fill="currentColor"></path></svg> <?php echo __( 'Card' );?></button>
						<?php } ?>
						<?php if(!empty($config->paysera_password)){?>
							<button id="lock_pro_video_sms_payment" onclick="lock_pro_video_pay_via_sms();" class="btn valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M2 20h20v2H2v-2zm2-8h2v7H4v-7zm5 0h2v7H9v-7zm4 0h2v7h-2v-7zm5 0h2v7h-2v-7zM2 7l10-5 10 5v4H2V7zm2 1.236V9h16v-.764l-8-4-8 4zM12 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" fill="currentColor"></path></svg> <?php echo __( 'SMS' );?></button>
						<?php } ?>
					</div>
				</div>
            </div>
