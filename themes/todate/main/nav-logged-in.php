        ...
        <div class="valign-wrapper nav-wrapper container-fluid">
			...
			<span class="dt_slide_menu" onclick="javascript:$('body').toggleClass('side_open');">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path
                            d="M3 4h18v2H3V4zm0 7h12v2H3v-2zm0 7h18v2H3v-2z" fill="currentColor"/></svg>
			</span>
                <a id="logo-container"
                   href="<?php echo $site_url; ?>/<?php if ($profile->verified == 1) { ?>find-matches<?php } ?>"
                   class="header_logo">
                    <img src="<?php echo $config->sitelogo; ?>" alt="" data-default="" data-light="">
                </a>
                <?php if ($profile->verified == 1) { ?>
                    <ul class="header_home_link hide_mobi_login">
                        <li class="header_msg">
                    ...
                    <ul >
                            ...
                            <div class="boost-div">
                                ...
                                <?php if ($profile->is_boosted == '1' && $boost_duration <= $config->boost_expire_time) { ?>
                                    <div class="boosted_message_expire"
                                        ...
                                        <button title='<?php echo __('Your boost will expire in'); ?> <?php echo __('minutes'); ?>'
                                                class='btn boost-running'>
                                            <p>
                                        ...
                                        <span class="global_boosted_time" data-show="no"
                                              data-boosted-time="<?php echo $boost_duration; ?>"></span>
                                    </div>
                            ...
                            <li class="header_credits">
                                <a href="<?php echo $site_url; ?>/credit" data-ajax="/credit"
                                   class="to_hdr_finance_btn">
                                    ...
                                    <span id="credit_amount"><?php echo (int)$profile->balance; ?></span> <?php echo __('Credits'); ?>
                                </a>
                            </li>
                        <?php } ?>
                        <li >
                            <a class='dropdown-trigger to_prem_btn' href="javascript:void(0);" data-target='language_menu'><span style="margin-right: 5px" class="flag-icon flag-icon-us flag-icon-squared"></span> <?php echo $_COOKIE['activeLang'];?></a>
                        ...
                        <li class="header_user">
                            <a href="javascript:void(0);" data-target="user_dropdown" class="dropdown-trigger">
                                <img src="<?php echo $profile->avater->avater; ?>"
                            ...
                            <ul id="user_dropdown" class="dropdown-content">
                                ...
                                <li>
                                    <a href="<?php echo $site_url; ?>/@<?php echo $profile->username; ?>"
                                       data-ajax="/@<?php echo $profile->username; ?>" id="profile_link">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                             height="24">
                                            <path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zM6.023 15.416C7.491 17.606 9.695 19 12.16 19c2.464 0 4.669-1.393 6.136-3.584A8.968 8.968 0 0 0 12.16 13a8.968 8.968 0 0 0-6.137 2.416zM12 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"
                                                  fill="currentColor"/>
                                        </svg> <?php echo __('Profile'); ?></a>
                                </li>
                                <li>
                                    ...
                                    <a href="<?php echo $site_url; ?>/visits" data-ajax="/visits">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                            ...
                                            <path d="M1.181 12C2.121 6.88 6.608 3 12 3c5.392 0 9.878 3.88 10.819 9-.94 5.12-5.427 9-10.819 9-5.392 0-9.878-3.88-10.819-9zM12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0-2a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"
                                                  fill="currentColor"/>
                                        </svg> <?php echo __('Visits'); ?></a>
                                </li>
                                <li class="divider" tabindex="-1"></li>
                                <li>
                                    <a href="<?php echo $site_url; ?>/settings/<?php echo $profile->username; ?>"
                                       data-ajax="/settings/<?php echo $profile->username; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                             height="24">
                                            <path d="M9.954 2.21a9.99 9.99 0 0 1 4.091-.002A3.993 3.993 0 0 0 16 5.07a3.993 3.993 0 0 0 3.457.261A9.99 9.99 0 0 1 21.5 8.876 3.993 3.993 0 0 0 20 12c0 1.264.586 2.391 1.502 3.124a10.043 10.043 0 0 1-2.046 3.543 3.993 3.993 0 0 0-3.456.261 3.993 3.993 0 0 0-1.954 2.86 9.99 9.99 0 0 1-4.091.004A3.993 3.993 0 0 0 8 18.927a3.993 3.993 0 0 0-3.457-.26A9.99 9.99 0 0 1 2.5 15.121 3.993 3.993 0 0 0 4 11.999a3.993 3.993 0 0 0-1.502-3.124 10.043 10.043 0 0 1 2.046-3.543A3.993 3.993 0 0 0 8 5.071a3.993 3.993 0 0 0 1.954-2.86zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"
                                                  fill="currentColor"/>
                                        </svg> <?php echo __('Settings'); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo $site_url; ?>/transactions" data-ajax="/transactions">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                            ...
                                            <path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm12 4v2h-4v2h4v2l3.5-3L15 7zM9 17v-2h4v-2H9v-2l-3.5 3L9 17z"
                                                  fill="currentColor"/>
                                        </svg> <?php echo __('Transactions'); ?></a>
                                </li>
                               ...
                               <!-- <li class="divider" tabindex="-1"></li>-->
                                <!--<li>
                                    <a href="javascript:void(0);" id="night_mode_toggle"
                                       data-night-text="<?php /*echo __('Night mode'); */?>"
                                       data-light-text="<?php /*echo __('Day mode'); */?>"
                                       data-mode='<?php /*echo Secure($config->nextmode) */?>'>
                                        <span><?php /*echo $config->nextmode_text; */?></span>
                ...
                <?php } else { ?>
                    <ul class="">
                        <li class="header_user">
                            ...
                            <ul id="user_dropdown" class="dropdown-content">
                                <li>
                                    <a href="javascript:void(0);" onclick="logout()" class="waves-effect">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                             height="24">
                                            <path d="M6.265 3.807l1.147 1.639a8 8 0 1 0 9.176 0l1.147-1.639A9.988 9.988 0 0 1 22 12c0 5.523-4.477 10-10 10S2 17.523 2 12a9.988 9.988 0 0 1 4.265-8.193zM11 12V2h2v10h-2z"
                                                  fill="currentColor"/>
