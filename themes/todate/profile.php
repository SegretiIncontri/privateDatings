				...
				<div class="info">
					<div class="combo dt_othr_ur_info">
                        <h2>
                            ...
                            <img class="badge-img" src="/themes/todate/assets/img/badge/badge_<?php echo $profile->pro_type;?>.png">
                            <?php endif;?>
                            <?php echo $profile->username;?><?php echo ( $profile->age  > 0 ) ? ", ". $profile->age : "";?>
...
<div id="buy_chat_credits" class="modal">
	...
	<div class="modal-footer">
		...
		<?php }else{ ?>
			<a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="modal-close waves-effect waves-light btn-flat btn_primary white-text">UPGRADE</a>
		<?php } ?>
	</div>
</div>
