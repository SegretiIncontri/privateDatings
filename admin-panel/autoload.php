...
$mod_pages = array('dashboard', 'mock-spam', 'manage-users', 'online-users', 'manage-stories', 'manage-pages', 'manage-groups', 'manage-posts', 'manage-articles', 'manage-events', 'manage-forum-threads', 'manage-forum-messages', 'manage-movies', 'manage-games', 'add-new-game', 'manage-user-ads', 'manage-reports', 'manage-third-psites', 'edit-movie');
if (!empty($_GET['path'])) {
...
<head>
    ...
    <link href="<?php echo Wo_LoadAdminLink('plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css'); ?>"
          rel="stylesheet">
    <link href="<?php echo Wo_LoadAdminLink('plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css'); ?>"
          rel="stylesheet">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $wo['site_url']; ?>"><img
                        src="<?php echo $wo['config']['theme_url']; ?>/assets/img/logo.png" alt=""></a>
        </div>
    </div>
</nav>
<!-- #Top Bar -->
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name">Welcome back, <a href="<?php echo $wo['user']['url']; ?>"
                                                   target="_blank"><?php echo $wo['user']['name']; ?></a></div>
                <div class="name" style="font-size: 12px">Logged in
                    as <?php echo ($is_admin) ? 'Administrator' : 'Moderator' ?></div>
            </div>
        </div>
        <!-- #User Info -->
        <!-- Menu -->
        <div class="menu">
            <ul class="list">
                        ...
                        <ul class="ml-menu">
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "general-settings")) { ?>
                                <li <?php echo ($page == 'general-settings') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('general-settings'); ?>">General
                                        Settings</a>
                                </li>
                            <?php } ?>
                ...
                <?php if ($is_admin == true
                    ...
                    <li <?php echo ($page == 'manage-verification-requests' || $page == 'mock-spam' || $page == 'manage-users' || $page == 'manage-verification-reqeusts' || $page == 'affiliates-settings' || $page == 'payment-requests' || $page == 'referrals-list' || $page == 'edit-user-permissions' || $page == 'manage-user-verification' || $page == 'manage-genders' || $page == 'add-genders' || $page == 'edit-genders' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'manage-success-stories' || $page == 'add-success-stories' || $page == 'edit-success-stories' || $page == 'manage-countries' || $page == 'add-countries' || $page == 'edit-countries') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-users")) { ?>
                                <li <?php echo ($page == 'mock-spam') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('mock-spam'); ?>">Send SPAM</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "manage-genders")) { ?>
                                <li <?php echo ($page == 'manage-genders' || $page == 'add-genders' || $page == 'edit-genders') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-genders'); ?>">Manage
                                        Genders</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "manage-countries")) { ?>
                                <li <?php echo ($page == 'manage-countries' || $page == 'add-countries' || $page == 'edit-countries') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-countries'); ?>">Manage
                                        Countries</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "manage-profile-fields")) { ?>
                                <li <?php echo ($page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-profile-fields'); ?>">Manage
                                        Custom Profile Fields</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "manage-success-stories")) { ?>
                                <li <?php echo ($page == 'manage-success-stories' || $page == 'add-success-stories' || $page == 'edit-success-stories') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-success-stories'); ?>">Manage
                                        success stories</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckRadioPermission($current_user_id, "manage-user-verification")) { ?>
                                <li <?php echo ($page == 'manage-user-verification') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-user-verification'); ?>">Manage
                                        user verification</a>
                                </li>
                            <?php } ?>
                ...
                <?php if ($is_admin == true
                    ...
                    <li <?php echo ($page == 'manage-payments' || $page == 'manage-subscriptions' || $page == 'payments' || $page == 'bank-receipts') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php } ?>
                            <li <?php echo ($page == 'manage-subscriptions') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-subscriptions'); ?>">Manage
                                    Subscriptions</a>
                            </li>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-payments")) { ?>
                                <li <?php echo ($page == 'manage-payments') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-payments'); ?>">Manage
                                        Payments</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "bank-receipts")) { ?>
                                <li <?php echo ($page == 'bank-receipts') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('bank-receipts'); ?>">Manage bank
                                        receipts</a>
                                </li>
                            <?php } ?>
                        </ul>
                ...
                <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-photos")) { ?>
                    <li <?php echo ($page == 'manage-photos') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-photos') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-photos'); ?>">Manage Photos &
                                    Videos</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="ml-menu">
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-stickers")) { ?>
                                <li <?php echo ($page == 'manage-stickers') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-stickers'); ?>">Manage
                                        stickers</a>
                                </li>
                            <?php } ?>
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-blog-categories")) { ?>
                                <li <?php echo ($page == 'manage-blog-categories') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-blog-categories'); ?>">Blog
                                        categories</a>
                                </li>
                            <?php } ?>
                ...
                <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-website-ads")) { ?>
                    <li <?php echo ($page == 'manage-website-ads') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-website-ads') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-website-ads'); ?>">Manage Website
                                    Ads</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "change-site-desgin")) { ?>
                                <li <?php echo ($page == 'change-site-desgin') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('change-site-desgin'); ?>">Change Site
                                        Design</a>
                                </li>
                            <?php } ?>
                        ...
                        <ul class="ml-menu">
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "fake-users")) { ?>
                                <li <?php echo ($page == 'fake-users') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('fake-users'); ?>">Fake User
                                        Generator</a>
                                </li>
                            <?php } ?>
                        ...
                        <ul class="ml-menu">
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "add-language")) { ?>
                                <li <?php echo ($page == 'add-language') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('add-language'); ?>">Add New Language &
                                        Keys</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-languages")) { ?>
                                <li <?php echo ($page == 'manage-languages') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-languages'); ?>">Manage
                                        Languages</a>
                                </li>
                            <?php } ?>
                        </ul>
                        ...
                        <ul class="ml-menu">
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-custom-pages")) { ?>
                                <li <?php echo ($page == 'manage-custom-pages' || $page == 'add-new-custom-page' || $page == 'edit-custom-page') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('manage-custom-pages'); ?>">Manage
                                        Custom Pages</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "edit-terms-pages")) { ?>
                                <li <?php echo ($page == 'edit-terms-pages') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('edit-terms-pages'); ?>">Edit Terms
                                        Pages</a>
                                </li>
                            <?php } ?>
                            <?php if ($is_admin == true) { ?>
                ...
                <?php if ($is_admin == true || CheckUserPermission($current_user_id, "push-notifications-system")) { ?>
                    <li <?php echo ($page == 'push-notifications-system') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'push-notifications-system') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('push-notifications-system'); ?>">Push
        ...
        <div class="legal">
            <div class="copyright">
                Copyright &copy; <?php echo date('Y') ?> <a
                        href="javascript:void(0);"><?php echo $wo['config']['siteName'] ?></a>.
            </div>
            <div class="version">
